...
def login():
    ...
    print(User_Name)
    print(User_Pass)
    if User_Name == "ak" and User_Pass == "1234":
        window.destroy()
        mainroot()
    else:
...
lgn_frame = Frame(window, bg='white', width=950, height=600)
lgn_frame.place(x=200, y=70)
txt = "WELCOME"
heading = Label(lgn_frame, text=txt, font=('yu gothic ui', 25, "bold"), bg="white",
                             bd=5,
                             relief=FLAT)
heading.place(x=80, y=30, width=300, height=30)
side_image = Image.open('images/vector.png')
photo = ImageTk.PhotoImage(side_image)
side_image_label = Label(lgn_frame, image=photo, bg='white')
side_image_label.image = photo
side_image_label.place(x=5, y=100)
sign_in_image = Image.open('images/hyy.png')
photo = ImageTk.PhotoImage(sign_in_image)
sign_in_image_label = Label(lgn_frame, image=photo, bg='white')
sign_in_image_label.image = photo
sign_in_image_label.place(x=620, y=130)
username_label = Label(lgn_frame, text="Username", bg="white", fg="#4f4e4d",
                                    font=("yu gothic ui", 13, "bold"))
username_label.place(x=550, y=300)
username_entry = Entry(lgn_frame, highlightthickness=0, relief=FLAT, bg="white", fg="cyan4",
...
username_icon_label = Label(lgn_frame, image=photo, bg='white')
...
lgn_button_label = Label(lgn_frame, image=photo, bg='white')
lgn_button_label.image = photo
lgn_button_label.place(x=550, y=450)
loginbtn= Button(lgn_button_label, text='LOGIN',command=login ,font=("yu gothic ui", 13, "bold"), width=20, bd=0,highlightthickness=0,
                    bg='#3047ff', cursor='hand2', activebackground='#3047ff', fg='white')
loginbtn.place(x=20, y=10)

password_label = Label(lgn_frame, text="Password", bg="white", fg="#4f4e4d",
                            font=("yu gothic ui", 13, "bold"))
password_label.place(x=550, y=380)

password_entry = Entry(lgn_frame, highlightthickness=0, relief=FLAT, bg="white", fg="cyan4",
...
password_icon_label = Label(lgn_frame, image=photo, bg='white')
...
def mainroot():
    ...
    def staff():
        ...
        Label(emp1inf,text="Ms. suare",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
        ...
        Label(emp1inf,text="Ms.grace",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
        ...
        Label(emp1inf,text="Ms. adrian",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
        ...
        Label(emp1inf,text="Ms.charllote",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
        ...
        def booking():
            if fn.get() == 'First Name' or ln.get() == 'Last Name' or cn.get() == 'Contact Number *' or em.get() == 'Email' or ad.get() == "Guest's Address" or noc.get() == 'Number of Children' or noa.get() == 'Number of Adults' or nod.get() == 'Number of Days of Stay' or roomn.get() == 'Enter Room Number':
                ...
                if temp[0] == 'Reserved':
                    ...
                    payroot.minsize(height=236,width=400)
